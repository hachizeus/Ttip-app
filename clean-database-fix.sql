-- CLEAN DATABASE FIX FOR TTIP
-- No syntax errors, complete and working
...
-- ============================================================================
-- 2. MIGRATE TRANSACTIONS TO TIPS
-- ============================================================================
...
WHERE tip.id IS NULL AND t.mpesa_tx_id IS NOT NULL AND t.worker_id IS NOT NULL;
